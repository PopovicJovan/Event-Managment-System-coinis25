  ...
  return (
    <footer className="bg-gray-900 text-white py-10 mt-16">
      <div className="max-w-6xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8">
        {/* Brand/Info */}
        <div>
          <h2 className="text-xl font-bold mb-4 text-purple-400">Event Management System</h2>
          <p className="text-gray-400">
            Discover and manage events across the world with ease. Built for organizers and party lovers alike.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-gray-300">
            ...
            <li><Link to="/parties" className="hover:text-purple-400">Parties</Link></li>
